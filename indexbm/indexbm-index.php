...
<head>
    ...
    <title>学工系统 - 后台首页</title>
    <meta name="description" content="学工系统 - 后台首页">
...
<?php include "../header-page.php";?>
    ...
    <?php include "../left-sidebar-page.php";?>
        ...
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                <li><a href="../indexbm/indexbm-index.php" class="am-icon-home">首页</a></li>
                <!-- <li><a href="#">分类</a></li>
            ...
            <div class="tpl-content-scope">
                <div class="note note-info">
                    ...
                    <p> 管理员属于教师用户，登陆时请选择教工类型。</p>
                    <p><span class="label label-danger">提示:</span> 初次登陆系统会跳转到修改密码界面，用户重设密码后点击保存修改按钮即可进入系统，下次登陆系统则要使用修改后的密码。
                    </p>
                </div>
            </div>
